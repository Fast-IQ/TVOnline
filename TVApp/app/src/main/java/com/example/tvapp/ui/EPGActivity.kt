...
class EPGActivity : AppCompatActivity() {
    ...
    private lateinit var currentTimeText: TextView--- TVApp/app/src/main/java/com/example/tvapp/ui/EPGActivity.kt (原始)
package com.example.tvapp.ui
...
+++ TVApp/app/src/main/java/com/example/tvapp/ui/EPGActivity.kt (修改后)
package com.example.tvapp.ui
